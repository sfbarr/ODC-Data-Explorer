...
type GrantsViewProps = {
  grants: any[]; // pre-filtered by the caller
  downloadFilename: string; // filename used by the Download CSV button
};
...
export default function GrantsView({ grants, downloadFilename }: GrantsViewProps) {
      ...
      <div className="resultsToolbar">
        <div className="resultsButtons">
          <button
            ...
            onClick={() => downloadCsv(grants, downloadFilename)}
          >
